...
+ Use _sentence embeddings_ of the documents:
  - [SentenceTransformers](https://www.sbert.net/)  [[@reimers-2019-sentence-bert]]{style="font-size:0.75em;"}
...
+ The Beige Book is more similar to the Minutes than to the SEPs:
  - The Beige Book reports on **current conditions**
  - The Minutes discusses both **current conditions** and **the outlook**
